...
public class ReportController {
    ...
    public Result<TurnoverReportVO> turnoverStatistics(
        ...
        log.info("营业额统计:{} {}",begin.toString(),end.toString());
    ...
    public Result<UserReportVO> userStatistics(
            @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate begin,
            @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate end) {
        log.info("用户统计:{} {}", begin.toString(), end.toString());
    ...
    public Result<OrderReportVO> ordersStatistics(
            @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate begin,
            @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate end) {
        log.info("订单统计:{} {}", begin.toString(), end.toString());
    ...
    public Result<SalesTop10ReportVO> top10(
            @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate begin,
            @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate end) {
        log.info("销售额top10:{} {}", begin.toString(), end.toString());
    ...
    public void export(HttpServletResponse response) {
        ...
        reportService.reportBusinessData(response);
    }
}
